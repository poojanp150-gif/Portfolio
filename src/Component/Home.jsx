                        ...
                        <div className="tech-stack my-4 cursor-pointer">
                            ...
                            <span className='lan-btn' data-aos="fade-up"
                                data-aos-duration="3000">REACT JS</span> 
                                 <span className='lan-btn' data-aos="fade-up"
                                data-aos-duration="3000">Node JS</span>
                        </div>
                        <div className='mt-4'>
                ...
                <div className="d-flex align-items-center justify-content-center text-center text-light mt-5" id="About">
                    <div className="container px-4">
                        ...
                        <p className="mx-auto mb-5 text-secondary fs-5" style={{ maxWidth: "750px" }} data-aos="fade-right">
                            ...
                            Hello, I’m <b className="text-white"> Poojan Patel</b> , a passionate MERN Stack Developer focused on building scalable and efficient full-stack web applications. I have completed a professional full-stack development course and actively work on improving my technical skills by exploring new technologies. I have built personal projects and a portfolio demonstrating my expertise in MongoDB, Express.js, React, and Node.js, including E-commerce websites, admin panels, and interactive user interfaces.
                        </p>


                        <div className="d-flex justify-content-center gap-4 flex-wrap ">
                            <a className='btn btn-hover-scale btn-lg text-white px-4' href="/poojan-patel.pdf" download style={{ backgroundColor: "#8b5cf6" }} data-aos="fade-up" data-aos-duration="2000">
                                    ...
                                    <div>
                                        <div className="pt-3 pb-5">
                                            <form action="" ref={formRef} onSubmit={onSubmit}>
                                                ...
                                                <button type="submit" disabled={sending} className="btn send_btn w-100 py-3 text-white rounded-3xl font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg active:scale-95">
